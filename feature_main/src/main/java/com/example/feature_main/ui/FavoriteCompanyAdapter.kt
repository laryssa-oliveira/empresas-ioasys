...
class FavoriteCompanyAdapter(
    private val callback: (Company) -> Unit,
    private val callbackLike: (company: Company, like: Boolean) -> Unit,
    private val callbackUpdateUi: (companies: MutableList<Company>) -> Unit
) : RecyclerView.Adapter<FavoriteCompanyAdapter.CompaniesViewHolder>() {
        ...
        fun bind(company: Company) {
            ...
            favImageView.setOnClickListener {
                ...
                if (company.favorite) {
                    ...
                    callbackUpdateUi.invoke(companies)
                    favImageView.setImageResource(R.drawable.ic_not_favorite)
                } else {
    ...
    fun setItems(list: MutableList<Company>) {
        companies = list
    }
}